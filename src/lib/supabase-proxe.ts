...
const proxeSupabaseUrl = process.env.NEXT_PUBLIC_PROXE_SUPABASE_URL ?? process.env.PROXE_SUPABASE_URL;
const proxeSupabaseAnonKey = process.env.NEXT_PUBLIC_PROXE_SUPABASE_ANON_KEY ?? process.env.PROXE_SUPABASE_ANON_KEY;
...
export function getSupabaseServiceClient(): SupabaseClient | null {
  const serviceKey = process.env.PROXE_SUPABASE_SERVICE_KEY;
