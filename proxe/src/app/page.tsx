...
import FeaturedSectionStats from '@/components/ui/FeaturedSectionStats';
...
import {
  ...
  EmailIcon,
  SmsIcon,
} from '@/components/shared/icons/HugeIcons';
      ...
      <FadeInSection className={styles.thirdSection} delay={200}>
        ...
        <div className={styles.bentoGrid}>
          ...
          <FadeInElement delay={200} animationType="fadeUp">
            ...
            <div className={styles.bentoCardImage}>
              <Image
                src="/assets/one memmory one vioce.webp"
          ...
          <FadeInElement delay={250}>
            ...
            <div className={styles.bentoCardImage}>
              <Image
                src="/assets/Command Center.webp"
