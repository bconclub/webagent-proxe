    ...
    if (isOpen && messages.length === 0 && !hasRestoredMessagesRef.current && !hasShownWelcomeRef.current && externalSessionId) {
      ...
      const fetchConversationsOnReopen = async () => {
        try {
          ...
          if (addAIMessage) {
            addAIMessage("Hi! I'm here to help you understand pilot training at WindChasers. Are you looking to start training soon, or just exploring options?");
            hasShownWelcomeRef.current = true;
          }
        } catch (err) {
          console.error('[ChatWidget] Error fetching conversations on reopen:', err);
        ...
        <div className={styles.welcomeQuickButtonsContainer}>
          <div className={styles.welcomeQuickButtonRow}>
            <button
              ...
              onClick={() => handleQuickButtonClick("What courses do you offer?")}
            >
          ...
          <div className={styles.welcomeQuickButtonRow}>
            <button
              ...
              onClick={() => handleQuickButtonClick("How much does pilot training cost?")}
            >
              How much does pilot training cost?
            </button>
            <button
              className={`${styles.quickBtn} ${styles['accent-2']}`}
              onClick={() => handleQuickButtonClick("Book demo class")}
            >
              Book demo class
            </button>
          </div>
          <div className={styles.welcomeQuickButtonRow}>
            <button
              ...
              onClick={() => handleQuickButtonClick("Check my eligibility")}
            >
