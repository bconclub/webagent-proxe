...
import { getSupabaseClient, getSupabaseServiceClient } from '@/windchasers/lib/supabase';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (externalSessionId) {
      addUserInput(externalSessionId, message, undefined, BRAND as 'windchasers').catch(err => {
